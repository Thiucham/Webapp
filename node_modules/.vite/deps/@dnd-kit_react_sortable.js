...
import { A as isKeyboardEvent, B as j, C as DOMRectangle, D as getComputedStyles, E as computeTranslate, F as Rectangle, I as WeakStore, L as deepEqual, M as scrollIntoViewIfNeeded, N as Plugin, O as getVisibleBoundingRectangle, P as resolveCustomizable, R as reactive, S as defaultCollisionDetection, T as animateTransform, V as n, _ as Feedback, b as Scroller, c as useInstance, d as useIsomorphicLayoutEffect, f as useOnElementChange, g as Droppable, h as Draggable, j as prefersReducedMotion, k as getWindow, l as useDeepSignal, m as currentValue, p as useOnValueChange, u as useImmediateEffect, w as ProxiedElements, x as closestCorners, z as f } from "./react-CHB03Osg.js";
...
var Sortable2 = class {
	constructor(_a, manager) {
		...
		this.droppable = new SortableDroppable(__spreadProps$1(__spreadValues$1({}, input), { disabled: disabledState.droppable }), manager, this);
...
function useSortable(input) {
	...
	useOnValueChange(disabled, () => sortable.disabled = disabled != null ? disabled : false, void 0, deepEqual);
	useOnValueChange(sensors, () => sortable.sensors = sensors, void 0, deepEqual);
...
//#endregion
export { isSortable, isSortableOperation, useSortable };
