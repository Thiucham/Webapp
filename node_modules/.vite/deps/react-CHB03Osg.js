...
var __name$3 = (target, value) => __defProp$4(target, "name", {
	value,
	configurable: true
});
...
function enumerable(enumerable2 = true) {
	return function(_value, context) {
		context.addInitializer(function() {
			...
			if (descriptor) Object.defineProperty(host, context.name, __spreadProps$3(__spreadValues$4({}, descriptor), { enumerable: enumerable2 }));
		});
	};
}
...
var ValueHistory = class {
	...
	set current(value) {
		const current = f(() => __privateGet$5(this, _ValueHistory_instances, current_get));
...
var WeakStore = class {
	constructor() {
		__privateAdd$5(this, _store, /* @__PURE__ */ new WeakMap());
	}
	get(key, id) {
		var _a2;
		return key ? (_a2 = __privateGet$5(this, _store).get(key)) == null ? void 0 : _a2.get(id) : void 0;
	}
	set(key, id, value) {
		var _a2;
		if (!key) return;
		if (!__privateGet$5(this, _store).has(key)) __privateGet$5(this, _store).set(key, /* @__PURE__ */ new Map());
		return (_a2 = __privateGet$5(this, _store).get(key)) == null ? void 0 : _a2.set(id, value);
	}
	clear(key) {
		var _a2;
		return key ? (_a2 = __privateGet$5(this, _store).get(key)) == null ? void 0 : _a2.clear() : void 0;
	}
};
...
var __name$2 = (target, value) => __defProp$3(target, "name", {
	value,
	configurable: true
});
...
var Rectangle = class _Rectangle {
	...
	translate(x, y) {
		...
		newShape.scale = __spreadValues$3({}, scale);
		return newShape;
	}
...
var __name$1 = (target, value) => __defProp$2(target, "name", {
	value,
	configurable: true
});
...
var Draggable$1 = class extends (_c$1 = Entity, _type_dec = [reactive], _modifiers_dec = [reactive], _status_dec = [reactive], _isDropping_dec = [derived], _isDragging_dec = [derived], _isDragSource_dec = [derived], _c$1) {
	constructor(_a, manager) {
		...
		super(__spreadProps$2(__spreadValues$2({}, input), { effects: () => {
			var _a2;
...
function defaultPreventable(event, cancelable = true) {
	...
	return __spreadProps$2(__spreadValues$2({}, event), {
		cancelable,
...
var DragOperation = class {
	...
	*/
	...
	get transform() {
		...
		for (const modifier of this.modifiers) transform = modifier.apply(__spreadProps$2(__spreadValues$2({}, this.snapshot()), { transform }));
...
injectAdoptedSheet_fn = function(root, rootStyles, cssRules) {
	if (!("adoptedStyleSheets" in root && Array.isArray(root.adoptedStyleSheets)) && true) console.error("Cannot inject styles: This browser doesn't support adoptedStyleSheets");
...
function useSignal(signal, sync = false) {
	const previous = (0, import_react.useRef)(signal.peek());
	const read = (0, import_react.useRef)(false);
	const forceUpdate = useForceUpdate();
	useIsomorphicLayoutEffect(() => j(() => {
		const previousValue = previous.current;
		const currentValue2 = signal.value;
		if (previousValue !== currentValue2) {
			previous.current = currentValue2;
			if (!read.current) return;
			if (sync) (0, import_react_dom.flushSync)(forceUpdate);
			else forceUpdate();
		}
	}), [
		signal,
...
function useComputed(compute, dependencies = [], sync = false) {
	const $compute = (0, import_react.useRef)(compute);
	$compute.current = compute;
	return useSignal((0, import_react.useMemo)(() => computed(() => $compute.current()), dependencies), sync);
}
...
function DragOverlay({ children, className, dropAnimation, style, tag, disabled }) {
	...
	const patchedManager = (0, import_react.useMemo)(() => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DragDropContext.Provider, {
		value: patchedManager,
		children: (0, import_react.createElement)(tag || "div", {
			ref,
			className,
			style,
	...
	function renderChildren() {
		...
		if (typeof children === "function") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Children, {
			source,
			children
		});
		return children;
...
//#endregion
export { isKeyboardEvent as A, j as B, DOMRectangle as C, getComputedStyles as D, computeTranslate as E, Rectangle as F, WeakStore as I, deepEqual as L, scrollIntoViewIfNeeded as M, Plugin as N, getVisibleBoundingRectangle as O, resolveCustomizable as P, reactive as R, defaultCollisionDetection$1 as S, animateTransform as T, n as V, Feedback as _, useDragOperation as a, Scroller as b, useInstance as c, useIsomorphicLayoutEffect as d, useOnElementChange as f, Droppable as g, Draggable as h, useDragDropMonitor as i, prefersReducedMotion as j, getWindow as k, useDeepSignal as l, currentValue as m, DragOverlay as n, useDraggable as o, useOnValueChange as p, useDragDropManager as r, useDroppable as s, DragDropProvider as t, useImmediateEffect as u, KeyboardSensor as v, ProxiedElements as w, closestCorners as x, PointerSensor as y, f as z };
